...
class Downloader:
    ...
    def __init__(self) -> None:
        self.window: Tk = Tk()
        self.window.title("Youtube_Download")
        self.window.resizable(0,0)
        self.window.geometry('640x480+300+200')
        
        self.img_logo: PhotoImage = PhotoImage(file="img/Banner.png")
        ...
        self.radio3: Radiobutton = Radiobutton(self.frame3, text="audio e video", value=2, command=self.validate_all)
    ...
    def msg(self: object) -> None:
        ...
        texto: Label = Label(windom, text="Link not valid", pady=30)
        texto.pack()
    ...
    def complete(self: object) -> None:
        windom: Toplevel = Toplevel()
        windom.title("COMPLETE")
        windom.resizable(0, 0)
        windom.geometry("300x200+300+200")
        
        texto: Label = Label(windom, text="Download complete", pady=30)
        texto.pack()
